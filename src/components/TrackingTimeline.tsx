...
export default function TrackingTimeline({ workOrder, subcontractor, driver }: Props) {
  ...
  const steps = [
    { label: "Material Pickup", code: "1_ToBeDispatched", desc: "Order issued at store" },
              ...
              {steps.map((s, idx) => {
                ...
                return (
                  <div key={s.code} className="flex flex-col items-center text-center w-24 shrink-0">
                    <div
                      className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full border-2 font-mono text-sm font-bold transition-all ${isPassed
